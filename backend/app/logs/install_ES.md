...
wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-9.2.0-linux-x86_64.tar.gz.sha512
shasum -a 512 -c elasticsearch-9.2.0-linux-x86_64.tar.gz.sha512
