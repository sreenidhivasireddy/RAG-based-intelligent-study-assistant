...
-- ==============================
-- 5. Table: synthetic_eval_dataset
-- ==============================
CREATE TABLE IF NOT EXISTS synthetic_eval_dataset (
  id VARCHAR(36) PRIMARY KEY COMMENT 'UUID primary key',
  document_id VARCHAR(32) NOT NULL COMMENT 'Document identifier (file_md5)',
  chunk_id VARCHAR(64) NOT NULL COMMENT 'Chunk identifier used for QA generation',
  question TEXT NOT NULL COMMENT 'Synthetic question',
  answer TEXT NOT NULL COMMENT 'Ground truth answer',
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'Created at timestamp',
  used_in_eval TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Marked after eval use',
  pipeline_version VARCHAR(64) NULL COMMENT 'Generation pipeline version',
  CONSTRAINT fk_synthetic_eval_document FOREIGN KEY (document_id) REFERENCES file_upload(file_md5)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Synthetic evaluation QA dataset table';
